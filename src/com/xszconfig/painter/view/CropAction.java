...
public class CropAction extends Action{
    ...
    private final int colorOfCropZone = Color.BLACK;
    ...
    public void draw(Canvas canvas){
		...
		mPaint.setColor(colorOfCropZone);
		...
		mPaint.setStrokeJoin(Paint.Join.ROUND);// 笔画拐弯方式，
												// ROUND圆狐拐角、BEVEL直线外沿拐角、MITER斜切效果拐角
