...
public class SizeBar extends View{
	/*
    ...
    /**
     * Interface and listener so that changes in SizeBar are sent
	...
	public SizeBar(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs, 0);
	}

	public SizeBar(Context context, AttributeSet attrs, int defStyle) {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if(onSizeChangedListener != null && oldChangedListenerValue != mColor){
	            onSizeChangedListener.onSizeChanged(mColor);
